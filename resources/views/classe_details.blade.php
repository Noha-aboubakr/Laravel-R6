        ...
        <div class="card bg-light border-0">
          <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">From:</span> {{date('h:i A', strtotime($classe['timefrom']))}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">To:</span> {{date('h:i A', strtotime($classe['timeto']))}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Is fulled:</span> {{$classe['isfulled'] ? 'Yes' : 'NO'}}
                </p>
              </div>
