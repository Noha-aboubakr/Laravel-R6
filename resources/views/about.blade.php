...
<header class="site-header section-padding-img site-header-image">
    ...
    <img src="{{asset('assets/new/images/header/businesspeople-meeting-office-working.jpg')}}" class="header-image img-fluid" alt="">
</header>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4 col-12">
                <div class="team-thumb d-flex align-items-center">
                    <img src="{{asset('assets/new/images/people/senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpeg')}}" class="img-fluid custom-circle-image team-image me-4" alt="">
            ...
            <div class="col-lg-4 mb-4 col-12">
                <div class="team-thumb d-flex align-items-center">
                    <img src="{{asset('assets/new/images/people/portrait-british-woman.jpeg')}}" class="img-fluid custom-circle-image team-image me-4" alt="">
            ...
            <div class="col-lg-4 mb-lg-0 mb-4 col-12">
                <div class="team-thumb d-flex align-items-center">
                    <img src="{{asset('assets/new/images/people/beautiful-woman-face-portrait-brown-background.jpeg')}}" class="img-fluid custom-circle-image team-image me-4" alt="">
                ...
                <div class="slick-testimonial">
                    <div class="slick-testimonial-caption">
                        ...
                        <div class="slick-testimonial-client d-flex align-items-center mt-4">
                            <img src="{{asset('assets/new/images/people/senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpeg')}}" class="img-fluid custom-circle-image me-3" alt="">
                    ...
                    <div class="slick-testimonial-caption">
                        ...
                        <div class="slick-testimonial-client d-flex align-items-center mt-4">
                            <img src="{{asset('assets/new/images/people/beautiful-woman-face-portrait-brown-background.jpeg')}}" class="img-fluid custom-circle-image me-3" alt="">
                    ...
                    <div class="slick-testimonial-caption">
                        ...
                        <div class="slick-testimonial-client d-flex align-items-center mt-4">
                            <img src="{{asset('assets/new/images/people/portrait-british-woman.jpeg')}}" class="img-fluid custom-circle-image me-3" alt="">
                    ...
                    <div class="slick-testimonial-caption">
                        ...
                        <div class="slick-testimonial-client d-flex align-items-center mt-4">
                            <img src="{{asset('assets/new/images/people/woman-wearing-mask-face-closeup-covid-19-green-background.jpeg')}}" class="img-fluid custom-circle-image me-3" alt="">
