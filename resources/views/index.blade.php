...
<html lang="en">
    <head>
        ...
        <link href="{{asset('assets/new/css/bootstrap-icons.css')}}" rel="stylesheet">

        <link rel="stylesheet" href="{{asset('assets/new/css/slick.css')}}"/>

        <link href="{{asset('assets/new/css/tooplate-little-fashion.css')}}" rel="stylesheet">
<!--
...
-->
    ...
    <body>
        ...
        <main>
            ...
            <section class="slick-slideshow">   
                <div class="slick-custom">
                    <img src="{{asset('assets/new/images/slideshow/medium-shot-business-women-high-five.jpeg')}}" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="{{asset('assets/new/images/slideshow/team-meeting-renewable-energy-project.jpeg')}}" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="{{asset('assets/new/images/slideshow/two-business-partners-working-together-office-computer.jpeg')}}" class="img-fluid" alt="">
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="tab-content mt-2" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="{{asset('assets/new/images/pim-chu-z6NZ76_UTDI-unsplash.jpeg')}}" class="img-fluid" alt="">
                                        </div>
                                ...
                                <div class="tab-pane fade" id="pills-skill" role="tabpanel" aria-labelledby="pills-skill-tab">
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="{{asset('assets/new/images/cody-lannom-G95AReIh_Ko-unsplash.jpeg')}}" class="img-fluid" alt="">
                                        </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{asset('assets/new/images/retail-shop-owner-mask-social-distancing-shopping.jpg')}}" class="img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="{{route('products.show', $product['id'])}}">
                                    <img src="{{asset('assets/new/images/' . $product['image'])}}" class="img-fluid product-image" alt="">
                                </a>
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="{{route('products.show', $product['id'])}}" class="product-title-link">{{$product['title']}}</a>
                                        </h5>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="{{asset('assets/new/images/product/nature-zen-3Dn1BZZv3m8-unsplash.jpeg')}}" class="img-fluid product-image" alt="">
                                </a>
        ...
        <script src="{{asset('assets/new/js/Headroom.js')}}"></script>
        <script src="{{asset('assets/new/js/jQuery.headroom.js')}}"></script>
        <script src="{{asset('assets/new/js/slick.min.js')}}"></script>
