        ...
        <div class="card bg-light border-0">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-10 position-relative overflow-hidden">
              <img src="{{asset('assets/new/images/' . $product->image) }}"
                alt="" class="card-img"
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Published:</span> {{$product['published'] ? 'YES' : 'NO'}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
              ...
              <div class="text-md-end">
                <a href="{{route('products.index')}}" class="btn mt-4 btn-primary text-white fs-5 fw-bold border-0 py-2 px-md-5">
